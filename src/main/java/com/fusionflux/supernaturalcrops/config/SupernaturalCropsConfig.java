...
public final class SupernaturalCropsConfig extends Config {
	...
	public static class MYTHICAL_METALS_ENABLED extends ConfigItemGroup {
		public static final ConfigItem<Boolean> ENABLE_Adamantite_CROPS = new ConfigItem<>("coal_adamantite_enabled", true,
				"config.supernaturalcrops.enabled.adamantite_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Aetherium_CROPS = new ConfigItem<>("coal_aetherium_enabled", true,
				"config.supernaturalcrops.enabled.aetherium_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Aquarium_CROPS = new ConfigItem<>("coal_aquarium_enabled", true,
				"config.supernaturalcrops.enabled.aquarium_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Argonium_CROPS = new ConfigItem<>("coal_argonium_enabled", true,
				"config.supernaturalcrops.enabled.argonium_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Banglum_CROPS = new ConfigItem<>("coal_banglum_enabled", true,
				"config.supernaturalcrops.enabled.banglum_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Brass_CROPS = new ConfigItem<>("coal_brass_enabled", true,
				"config.supernaturalcrops.enabled.brass_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Bronze_CROPS = new ConfigItem<>("coal_bronze_enabled", true,
				"config.supernaturalcrops.enabled.bronze_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Carmot_CROPS = new ConfigItem<>("coal_carmot_enabled", true,
				"config.supernaturalcrops.enabled.carmot_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Celestium_CROPS = new ConfigItem<>("coal_celestium_enabled", true,
				"config.supernaturalcrops.enabled.celestium_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Copper_CROPS = new ConfigItem<>("coal_copper_enabled", true,
				"config.supernaturalcrops.enabled.copper_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Discordium_CROPS = new ConfigItem<>("coal_discordium_enabled", true,
				"config.supernaturalcrops.enabled.discordium_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Durasteel_CROPS = new ConfigItem<>("coal_durasteel_enabled", true,
				"config.supernaturalcrops.enabled.durasteel_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Electrum_CROPS = new ConfigItem<>("coal_electrum_enabled", true,
				"config.supernaturalcrops.enabled.electrum_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Etherite_CROPS = new ConfigItem<>("coal_etherite_enabled", true,
				"config.supernaturalcrops.enabled.etherite_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Hallowed_CROPS = new ConfigItem<>("coal_hallowed_enabled", true,
				"config.supernaturalcrops.enabled.hallowed_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Kyber_CROPS = new ConfigItem<>("coal_kyber_enabled", true,
				"config.supernaturalcrops.enabled.kyber_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Manganese_CROPS = new ConfigItem<>("coal_manganese_enabled", true,
				"config.supernaturalcrops.enabled.manganese_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Metallurgium_CROPS = new ConfigItem<>("coal_metallurgium_enabled", true,
				"config.supernaturalcrops.enabled.metallurgium_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Midas_Gold_CROPS = new ConfigItem<>("coal_midas_gold_enabled", true,
				"config.supernaturalcrops.enabled.midas_gold_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Mythril_CROPS = new ConfigItem<>("coal_mythril_enabled", true,
				"config.supernaturalcrops.enabled.mythril_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Orichalcum_CROPS = new ConfigItem<>("coal_orichalcum_enabled", true,
				"config.supernaturalcrops.enabled.orichalcum_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Osmium_CROPS = new ConfigItem<>("coal_osmium_enabled", true,
				"config.supernaturalcrops.enabled.osmium_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Platinum_CROPS = new ConfigItem<>("coal_platinum_enabled", true,
				"config.supernaturalcrops.enabled.platinum_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Prometheum_CROPS = new ConfigItem<>("coal_prometheum_enabled", true,
				"config.supernaturalcrops.enabled.prometheum_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Quadrillum_CROPS = new ConfigItem<>("coal_quadrillum_enabled", true,
				"config.supernaturalcrops.enabled.quadrillum_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Quicksilver_CROPS = new ConfigItem<>("coal_quicksilver_enabled", true,
				"config.supernaturalcrops.enabled.quicksilver_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Runite_CROPS = new ConfigItem<>("coal_runite_enabled", true,
				"config.supernaturalcrops.enabled.runite_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Silver_CROPS = new ConfigItem<>("coal_silver_enabled", true,
				"config.supernaturalcrops.enabled.silver_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Slowsilver_CROPS = new ConfigItem<>("coal_slowsilver_enabled", true,
				"config.supernaturalcrops.enabled.slowsilver_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Starrite_CROPS = new ConfigItem<>("coal_starrite_enabled", true,
				"config.supernaturalcrops.enabled.starrite_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Steel_CROPS = new ConfigItem<>("coal_steel_enabled", true,
				"config.supernaturalcrops.enabled.steel_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Stormyx_CROPS = new ConfigItem<>("coal_stormyx_enabled", true,
				"config.supernaturalcrops.enabled.stormyx_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Tantalite_CROPS = new ConfigItem<>("coal_tantalite_enabled", true,
				"config.supernaturalcrops.enabled.tantalite_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Tin_CROPS = new ConfigItem<>("coal_tin_enabled", true,
				"config.supernaturalcrops.enabled.tin_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Truesilver_CROPS = new ConfigItem<>("coal_truesilver_enabled", true,
				"config.supernaturalcrops.enabled.truesilver_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Unobtainium_CROPS = new ConfigItem<>("coal_unobtainium_enabled", true,
				"config.supernaturalcrops.enabled.unobtainium_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Ur_CROPS = new ConfigItem<>("coal_ur_enabled", true,
				"config.supernaturalcrops.enabled.ur_crop_enabled");
		public static final ConfigItem<Boolean> ENABLE_Zinc_CROPS = new ConfigItem<>("coal_zinc_enabled", true,
	...
	public static class MYTHICAL_METALS_NUGGET_BALANCE extends ConfigItemGroup {
		...
		public static final ConfigItem<Boolean> ENABLE_Metallurgium_CROP_NUGGETS = new ConfigItem<>("metallurgium_crop_nuggets_enabled", false,
				"config.supernaturalcrops.nugget_balance.metallurgium_crop_nuggets_enabled");
		public static final ConfigItem<Boolean> ENABLE_Midas_Gold_CROP_NUGGETS = new ConfigItem<>("midas_gold_crop_nuggets_enabled", false,
				"config.supernaturalcrops.nugget_balance.midas_gold_crop_nuggets_enabled");
		public static final ConfigItem<Boolean> ENABLE_Mythril_CROP_NUGGETS = new ConfigItem<>("mythril_crop_nuggets_enabled", false,
				"config.supernaturalcrops.nugget_balance.mythril_crop_nuggets_enabled");
		...
		public static final ConfigItem<Boolean> ENABLE_Prometheum_CROP_NUGGETS = new ConfigItem<>("prometheum_crop_nuggets_enabled", false,
				"config.supernaturalcrops.nugget_balance.prometheum_crop_nuggets_enabled");
		public static final ConfigItem<Boolean> ENABLE_Quadrillum_CROP_NUGGETS = new ConfigItem<>("quadrillum_crop_nuggets_enabled", false,
				"config.supernaturalcrops.nugget_balance.quadrillum_crop_nuggets_enabled");
		...
		public static final ConfigItem<Boolean> ENABLE_Truesilver_CROP_NUGGETS = new ConfigItem<>("truesilver_crop_nuggets_enabled", false,
				"config.supernaturalcrops.nugget_balance.truesilver_crop_nuggets_enabled");
	...
	private static final List<ConfigItemGroup> CONFIGS = ImmutableList.of(new ENABLED(),new NUGGET_BALANCE(),new MYTHICAL_METALS_ENABLED(),new MYTHICAL_METALS_NUGGET_BALANCE());
